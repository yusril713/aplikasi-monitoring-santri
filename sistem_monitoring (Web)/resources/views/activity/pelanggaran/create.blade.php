    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="shadow p-3 mb-5 bg-white rounded">
                ...
                @endif
                <form action="{{ route('pelanggaran.store') }}" method="POST" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-group" style="padding-top:20px">
                        ...
                        <textarea name="pelanggaran" class="form-control" placeholder="Masukkan Pelanggaran santri"></textarea>
                    </div>
